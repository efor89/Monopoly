            ...
            if($item->getName() === "§aSpiel Starten") {
				if($gamecfg->get("start") !== true){
			        if(count(Server::getInstance()->getOnlinePlayers()) > 1){
						...
						$p->getLevel()->setBlock(new Vector3($x1, $y1, $z1), Block::get(165, 0));
						$p->getLevel()->setBlock(new Vector3($x2, $y1, $z2), Block::get(19, 0));
					    if($Player3 != null){
					        $player3->getInventory()->clearAll();
							$p->getLevel()->setBlock(new Vector3($x3, $y1, $z3), Block::get(91, 0));
					    }
					    if($Player4 != null){
					        $player4->getInventory()->clearAll();
							$p->getLevel()->setBlock(new Vector3($x4, $y1, $z4), Block::get(170, 0));
					    }
						...
						$x10 = $config->getNested("9.bx2");
						$z10 = $config->getNested("9.bz2");
						$p->getLevel()->setBlock(new Vector3($x9, $y, $z9), $block);
						$p->getLevel()->setBlock(new Vector3($x10, $y, $z10), $block);
						$x11 = $config->getNested("10.bx1");
						$z11 = $config->getNested("10.bz1");
						$x12 = $config->getNested("10.bx2");
						$z12 = $config->getNested("10.bz2");
						$p->getLevel()->setBlock(new Vector3($x11, $y, $z11), $block);
						$p->getLevel()->setBlock(new Vector3($x12, $y, $z12), $block);
						$x13 = $config->getNested("12.bx1");
						$z13 = $config->getNested("12.bz1");
						$x14 = $config->getNested("12.bx2");
						$z14 = $config->getNested("12.bz2");
						$p->getLevel()->setBlock(new Vector3($x13, $y, $z13), $block);
						$p->getLevel()->setBlock(new Vector3($x14, $y, $z14), $block);
						$x15 = $config->getNested("13.bx1");
						$z15 = $config->getNested("13.bz1");
						$x16 = $config->getNested("13.bx2");
						$z16 = $config->getNested("13.bz2");
						$p->getLevel()->setBlock(new Vector3($x15, $y, $z15), $block);
						$p->getLevel()->setBlock(new Vector3($x16, $y, $z16), $block);
						$x17 = $config->getNested("14.bx1");
						$z17 = $config->getNested("14.bz1");
						$x18 = $config->getNested("14.bx2");
						$z18 = $config->getNested("14.bz2");
						$p->getLevel()->setBlock(new Vector3($x17, $y, $z17), $block);
						$p->getLevel()->setBlock(new Vector3($x18, $y, $z18), $block);
						$x19 = $config->getNested("15.bx1");
						$z19 = $config->getNested("15.bz1");
						$x20 = $config->getNested("15.bx2");
						$z20 = $config->getNested("15.bz2");
						$p->getLevel()->setBlock(new Vector3($x19, $y, $z19), $block);
						$p->getLevel()->setBlock(new Vector3($x20, $y, $z20), $block);
						$x21 = $config->getNested("16.bx1");
						$z21 = $config->getNested("16.bz1");
						$x22 = $config->getNested("16.bx2");
						$z22 = $config->getNested("16.bz2");
						$p->getLevel()->setBlock(new Vector3($x21, $y, $z21), $block);
						$p->getLevel()->setBlock(new Vector3($x22, $y, $z22), $block);
						$x23 = $config->getNested("17.bx1");
						$z23 = $config->getNested("17.bz1");
						$x24 = $config->getNested("17.bx2");
						$z24 = $config->getNested("17.bz2");
						$p->getLevel()->setBlock(new Vector3($x23, $y, $z23), $block);
						$p->getLevel()->setBlock(new Vector3($x24, $y, $z24), $block);
						$x25 = $config->getNested("19.bx1");
						$z25 = $config->getNested("19.bz1");
						$x26 = $config->getNested("19.bx2");
						$z26 = $config->getNested("19.bz2");
						$p->getLevel()->setBlock(new Vector3($x25, $y, $z25), $block);
						$p->getLevel()->setBlock(new Vector3($x26, $y, $z26), $block);
						$x27 = $config->getNested("20.bx1");
						$z27 = $config->getNested("20.bz1");
						$x28 = $config->getNested("20.bx2");
						$z28 = $config->getNested("20.bz2");
						$p->getLevel()->setBlock(new Vector3($x27, $y, $z27), $block);
						$p->getLevel()->setBlock(new Vector3($x28, $y, $z28), $block);
						$x29 = $config->getNested("22.bx1");
						$z29 = $config->getNested("22.bz1");
						$x30 = $config->getNested("22.bx2");
						$z30 = $config->getNested("22.bz2");
						$p->getLevel()->setBlock(new Vector3($x29, $y, $z29), $block);
						$p->getLevel()->setBlock(new Vector3($x30, $y, $z30), $block);
						$x31 = $config->getNested("24.bx1");
						$z31 = $config->getNested("24.bz1");
						$x32 = $config->getNested("24.bx2");
						$z32 = $config->getNested("24.bz2");
						$p->getLevel()->setBlock(new Vector3($x31, $y, $z31), $block);
						$p->getLevel()->setBlock(new Vector3($x32, $y, $z32), $block);
						$x33 = $config->getNested("25.bx1");
						$z33 = $config->getNested("25.bz1");
						$x34 = $config->getNested("25.bx2");
						$z34 = $config->getNested("25.bz2");
						$p->getLevel()->setBlock(new Vector3($x33, $y, $z33), $block);
						$p->getLevel()->setBlock(new Vector3($x34, $y, $z34), $block);
						$x35 = $config->getNested("26.bx1");
						$z35 = $config->getNested("26.bz1");
						$x36 = $config->getNested("26.bx2");
						$z36 = $config->getNested("26.bz2");
						$p->getLevel()->setBlock(new Vector3($x35, $y, $z35), $block);
						$p->getLevel()->setBlock(new Vector3($x36, $y, $z36), $block);
						$x37 = $config->getNested("27.bx1");
						$z37 = $config->getNested("27.bz1");
						$x38 = $config->getNested("27.bx2");
						$z38 = $config->getNested("27.bz2");
						$p->getLevel()->setBlock(new Vector3($x37, $y, $z37), $block);
						$p->getLevel()->setBlock(new Vector3($x38, $y, $z38), $block);
						$x39 = $config->getNested("28.bx1");
						$z39 = $config->getNested("28.bz1");
						$x40 = $config->getNested("28.bx2");
						$z40 = $config->getNested("28.bz2");
						$p->getLevel()->setBlock(new Vector3($x39, $y, $z39), $block);
						$p->getLevel()->setBlock(new Vector3($x40, $y, $z40), $block);
						$x41 = $config->getNested("29.bx1");
						$z41 = $config->getNested("29.bz1");
						$x42 = $config->getNested("29.bx2");
						$z42 = $config->getNested("29.bz2");
						$p->getLevel()->setBlock(new Vector3($x41, $y, $z41), $block);
						$p->getLevel()->setBlock(new Vector3($x42, $y, $z42), $block);
						$x43 = $config->getNested("30.bx1");
						$z43 = $config->getNested("30.bz1");
						$x44 = $config->getNested("30.bx2");
						$z44 = $config->getNested("30.bz2");
						$p->getLevel()->setBlock(new Vector3($x43, $y, $z43), $block);
						$p->getLevel()->setBlock(new Vector3($x44, $y, $z44), $block);
						$x45 = $config->getNested("32.bx1");
						$z45 = $config->getNested("32.bz1");
						$x46 = $config->getNested("32.bx2");
						$z46 = $config->getNested("32.bz2");
						$p->getLevel()->setBlock(new Vector3($x45, $y, $z45), $block);
						$p->getLevel()->setBlock(new Vector3($x46, $y, $z46), $block);
						$x47 = $config->getNested("33.bx1");
						$z47 = $config->getNested("33.bz1");
						$x48 = $config->getNested("33.bx2");
						$z48 = $config->getNested("33.bz2");
						$p->getLevel()->setBlock(new Vector3($x47, $y, $z47), $block);
						$p->getLevel()->setBlock(new Vector3($x48, $y, $z48), $block);
						$x49 = $config->getNested("35.bx1");
						$z49 = $config->getNested("35.bz1");
						$x50 = $config->getNested("35.bx2");
						$z50 = $config->getNested("35.bz2");
						$p->getLevel()->setBlock(new Vector3($x49, $y, $z49), $block);
						$p->getLevel()->setBlock(new Vector3($x50, $y, $z50), $block);
						$x51 = $config->getNested("36.bx1");
						$z51 = $config->getNested("36.bz1");
						$x52 = $config->getNested("36.bx2");
						$z52 = $config->getNested("36.bz2");
						$p->getLevel()->setBlock(new Vector3($x51, $y, $z51), $block);
						$p->getLevel()->setBlock(new Vector3($x52, $y, $z52), $block);
						$x53 = $config->getNested("38.bx1");
						$z53 = $config->getNested("38.bz1");
						$x54 = $config->getNested("38.bx2");
						$z54 = $config->getNested("38.bz2");
						$p->getLevel()->setBlock(new Vector3($x53, $y, $z53), $block);
						$p->getLevel()->setBlock(new Vector3($x54, $y, $z54), $block);
						$x55 = $config->getNested("40.bx1");
						$z55 = $config->getNested("40.bz1");
						$x56 = $config->getNested("40.bx2");
						$z56 = $config->getNested("40.bz2");
						$p->getLevel()->setBlock(new Vector3($x55, $y, $z55), $block);
						$p->getLevel()->setBlock(new Vector3($x56, $y, $z56), $block);
					}else{
